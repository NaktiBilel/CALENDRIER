...
const AddSecteur = () => {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      const addResponse = await axios.post('http://localhost:3002/secteurs', values);
  ...
  return (
    <Box m="20px">
      <Header title="Add secteur" subtitle="secteur" />
          ...
          <Form style={styles.form}>
            ...
            <div style={styles.row}>
              <div style={styles.inputGroup}>
                <label htmlFor="name">Secteur</label>
                <Field
                  type="text"
                  id="name"
                  name="name"
