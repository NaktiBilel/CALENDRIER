...
const ListRue = () => {
  ...
  const handleAddUsersClick = () => {
    navigate('/AddRue'); // Navigation vers la page du formulaire lors du clic sur le bouton
  };
  ...
  return (
    ...
    <Box m="20px"  sx={{
      ...
      <Header title="Region" subtitle="Managing Banque Members" />
