...
const Tache = () => {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      const response = await axios.post('http://localhost:3002/taches',values);
  ...
  const initialValues = {
    ...
    date_fin: "",
    temps_fin: "",
    type_tache: "fort" // Définir une valeur par défaut pour le type de tâche
  };
  ...
  return (
    <Box m="20px">
      <Header title="Tâche" subtitle="Gestion des tâches" />
      <Formik
          ...
          <div style={styles.formContainer}>
            <Form>
              ...
              <div style={{ marginTop: "12px" }}>
                <label htmlFor="type_tache" style={{ paddingRight: "23px", fontSize: "22px" }}>Type de tâche</label>
                <Field as="select"
                  id="type_tache"
                  name="type_tache"
                  style={{ fontSize: "22px", color: "black" }}
                  value={values.type_tache}
