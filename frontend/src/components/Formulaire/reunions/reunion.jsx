...
const Reunion = () => {
  ...
  const validationSchema = yup.object({
    ...
    description: yup.string()
      .required("Le champ description fin est obligatoire.")
      .min(10,"Le champ description doit avoir au minimum 20 caractères"),
    date_debut: yup.date()
      ...
      const handleSubmit = async (values) => {
        try {
          ...
          const response = await axios.post('http://localhost:3002/reunions',values);
  ...
  const initialValues = { 
    ...
    temps_debut: "", 
    temps_fin: "", 
    type_reunion: "fort" // Définir une valeur par défaut pour le type de réunion
  };
  ...
  return (
    <Box m="20px">
      <Header title="Réunion" subtitle="Gestion des Réunions" />
      <Formik
